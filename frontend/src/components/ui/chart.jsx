        ...
        __html: Object.entries(config)
          ...
          .map(([key, itemConfig]) => {
            const color =
              ...
              `hsl(var(--chart-${key}))`;
            return `
              [data-chart="${id}"] .recharts-layer:has(.recharts-area[name="${key}"]) .recharts-area {
                fill: ${color};
                fill-opacity: 0.4;
              }
              [data-chart="${id}"] .recharts-layer:has(.recharts-line[name="${key}"]) .recharts-line {
                stroke: ${color};
              }
              [data-chart="${id}"] .recharts-layer:has(.recharts-bar[name="${key}"]) .recharts-bar {
                fill: ${color};
              }
            `;
          })
